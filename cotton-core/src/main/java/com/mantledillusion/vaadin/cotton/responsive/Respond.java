...
/**
 * {@link Responsive} annotation declaring the annotated {@link com.vaadin.flow.component.Component} to be
...
public @interface Respond {
     ...
     */
    Class<? extends ResponsiveClass> to();
